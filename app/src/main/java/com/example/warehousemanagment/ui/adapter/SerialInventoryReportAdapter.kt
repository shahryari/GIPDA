...
class SerialInventoryReportAdapter(): RecyclerView.Adapter<SerialInventoryReportAdapter.MyViewHolder>()
{
    private lateinit var context: Context
    private  var arrayList:List<SerialInventoryRows> =ArrayList()
    lateinit var onCallBackListener:OnCallBackListener

    constructor(arrayList: List<SerialInventoryRows>, context: Context, onCallBackListener: OnCallBackListener):this() {
