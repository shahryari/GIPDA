...
class SerialShippingViewModel(application: Application,context: Context): AndroidViewModel(application)
{
    ...
    )
    {
        viewModelScope.launch()
        {
            ...
            repository.serialShippingTruckList(baseUrl,jsonObject, page, rows, sort, asc, cookie)
                .subscribe(
                    {
