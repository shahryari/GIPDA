...
import com.example.warehousemanagment.databinding.DialogSheetOfflineSumbitBinding
import com.example.warehousemanagment.model.classes.clearEdi
import com.example.warehousemanagment.model.classes.textEdi
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class SheetOfflineSubmitDialog() : BottomSheetDialogFragment()
{
    ...
    {
        val binding=DialogSheetOfflineSumbitBinding.inflate(inflater,container,false)
//        binding.fileName.setText(msg)
        ...
        binding.okCanselBtn.ok.setOnClickListener {
            onClickListener.onOkClick(binding.progress, textEdi(binding.countEdi), textEdi(binding.fileName))
        }
    ...
    interface OnClickListener{
        fun onCanselClick()
        fun onOkClick(progress: ProgressBar, toInt: String, fileName: String)
        fun onCloseClick()
