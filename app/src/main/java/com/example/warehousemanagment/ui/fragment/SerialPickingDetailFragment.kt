...
class SerialPickingDetailFragment : BaseFragment<SerialPickingDetailViewModel,FragmentDetailPickingBinding>() {
    private lateinit var pickingId: String
    ...
    private lateinit var pickingLocationCode:String
        ...
        val adapter = PickingDetailAdapter(serialList, requireActivity(),
            object : PickingDetailAdapter.OnCallBackListener {
                override fun onItemClick(model: PickingDetailRow) {
                    ...
                    bundle.putString(Utils.locationCode,pickingLocationCode)
    ...
    override fun init() {
        setToolbarTitle(requireActivity(), "Serial Picking Detail")
