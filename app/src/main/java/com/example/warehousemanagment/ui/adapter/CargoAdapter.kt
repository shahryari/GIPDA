...
class CargoAdapter(): RecyclerView.Adapter<CargoAdapter.MyViewHolder>()
{
    private lateinit var context: Context
    private  var arrayList:List<CargoRow> =ArrayList()
    lateinit var onCallBackListener:OnCallBackListener

    constructor(arrayList: List<CargoRow>, context: Context, onCallBackListener: OnCallBackListener):this() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int)
    {
        ...
        holder.b.driverFullName.setText(model.driverFullName)
        ...
        holder.b.img.setImageResource(R.drawable.driver_default)
    ...
    interface OnCallBackListener{
        fun onClick(model: CargoRow, position: Int, progressBar: ProgressBar)
