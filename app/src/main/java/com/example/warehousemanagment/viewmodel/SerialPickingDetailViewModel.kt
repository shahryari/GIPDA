...
class SerialPickingDetailViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun completePicking(
        ...
        viewModelScope.launch()
        {
            ...
            repository.completeSerialPicking(baseUrl,jsonObject,cookie).subscribe({
    ...
    )
    {
        viewModelScope.launch()
        {
            ...
            repository.serialPickTruckDetailList(baseUrl,jsonObject, page, rows, sort, asc,cookie)
                .subscribe({
